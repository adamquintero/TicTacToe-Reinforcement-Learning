...
class MinimaxDeterministic(object):
    ...
    def minimax(self, state, ava_actions):
        ...
        def minimax_recursive(state, mark, current_depth, is_maximizing):
            ...
            if is_maximizing:
                ...
                return best_actions[0] if current_depth == 0 else max_eval
                ...
                return best_actions[0] if current_depth == 0 else min_eval
...
def _play(load_file, vs_agent, show_number):
    ...
    td_agent = MinimaxDeterministic('X')
    start_mark = 'O'
